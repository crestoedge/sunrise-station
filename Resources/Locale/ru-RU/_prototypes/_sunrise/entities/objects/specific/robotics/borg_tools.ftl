...
ent-HypoBorgMedicalUniversal = универсальный гипоспрей продвинутого медицинского киборга
    .desc = Версия обычного гипоспрея для киборга, требующая пациентов стоять на месте, но может вводить больше вещества за раз.
